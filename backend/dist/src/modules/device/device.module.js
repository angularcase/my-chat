...
exports.DeviceModule = DeviceModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [device_service_1.DeviceService, push_notification_service_1.PushNotificationService],
        exports: [device_service_1.DeviceService, push_notification_service_1.PushNotificationService],
    })
], DeviceModule);
